      ...
      <CardContent className="space-y-4">
            ...
            {(() => {
              ...
              return displayMeasurements.map((measurement) => (
                <div
                  ...
                  className="p-4 bg-white rounded-lg flex items-center justify-between cursor-pointer hover:shadow-md transition-shadow"
                >
                  <div>
        ...
        <div className="flex justify-center">
          <Button
            ...
            className="bg-white border-[#0F4C75] border-2 hover:bg-[#0F4C75]/90 text-[#0F4C75] hover:text-white transition-all duration-300 ease-in-out"
          >
